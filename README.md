...
### OPTIONAL: Plotting and saving results

Functions for plotting and saving are also provided.  To use them, you need to install [PyPlot](https://github.com/JuliaPy/PyPlot.jl) and [JLD](https://github.com/JuliaIO/JLD.jl), respectively. PyPlot enables you to plot results. JLD enables you to save/load results from file. To install JLD, run the following command in Julia:
```
Pkg.add("JLD")
```
...
Pkg.add("PyPlot")
```
If not, you can either (a) not use the plotting functions in BayesianMixtures, or (b) try your luck with the [PyPlot installation instructions](https://github.com/JuliaPy/PyPlot.jl).
